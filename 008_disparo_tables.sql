                                                                                                                                    ...
                                                                                                                                    sent_at                   timestamptz,
                                                                                                                                      error                     text,
                                                                                                                                        ...
                                                                                                                                        CREATE INDEX IF NOT EXISTS idx_reactivation_dispatches_campaign_status
                                                                                                                                          ...
                                                                                                                                          -- 8. Colunas de reativaÃ§Ã£o na tabela leads
                                                                                                                                          ...
                                                                                                                                          -- 9. RPCs para incremento atÃ´mico
...
-- 10. RPCs para incremento atômico de reativação
CREATE OR REPLACE FUNCTION increment_reactivation_sent(p_campaign_id uuid)
RETURNS void LANGUAGE sql AS $$
  UPDATE reactivation_campaigns SET sent_count = sent_count + 1 WHERE id = p_campaign_id;
$$;

CREATE OR REPLACE FUNCTION increment_reactivation_failed(p_campaign_id uuid)
RETURNS void LANGUAGE sql AS $$
  UPDATE reactivation_campaigns SET failed_count = failed_count + 1 WHERE id = p_campaign_id;
$$;