...
export function ChatArea({ messages, lead, onSend }: ChatAreaProps) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-alliance-col/30">
      {/* Messages area */}
      <div className="flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-3">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center text-gray-300">
          ...
          >
            <div className="flex items-center gap-3">
              <input
                ...
                disabled={isSending}
                className="flex-1 bg-gray-50 border border-gray-200 rounded-full px-4 py-2.5 text-sm outline-none focus-visible:ring-2 focus-visible:ring-alliance-blue/30 focus-visible:border-alliance-blue transition cursor-text disabled:opacity-60 disabled:cursor-not-allowed"
              />
              <button
                onClick={handleSend}
