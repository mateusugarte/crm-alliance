    ...
    <div className="px-8 py-7">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
        <div className="grid gap-6">
          <section className="overflow-hidden rounded-lg border border-line bg-surface elev-sm dark:border-white/10 dark:bg-surface/5">
            <div className="border-b border-line px-5 py-4 dark:border-white/10">
              <h2 className="font-semibold text-ink dark:text-white">Usuários do sistema</h2>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full min-w-[820px] text-left text-sm">
                <thead className="bg-surface-sunken text-xs   text-ink-muted dark:bg-surface/5 dark:text-ink-subtle">
                  <tr>
                  ...
                  {userRows.map((user) => {
                    ...
                    return (
                      <tr key={user.id} className="text-ink">
                        ...
                        <td className="px-5 py-4">
                          <span className="rounded-md bg-surface-sunken px-2 py-1 text-xs font-semibold uppercase text-ink dark:bg-surface/10 dark:text-ink-subtle">
          ...
          <section className="overflow-hidden rounded-lg border border-line bg-surface elev-sm dark:border-white/10 dark:bg-surface/5">
            <div className="border-b border-line px-5 py-4 dark:border-white/10">
              <h2 className="font-semibold text-ink dark:text-white">Últimos acessos registrados</h2>
            </div>
            <div className="overflow-x-auto">
