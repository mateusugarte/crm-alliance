  ...
  return (
    <div className="px-8 py-7 flex flex-col gap-6">
      <div>
        <Link
          href="/imoveis"
          className="inline-flex items-center gap-1.5 text-xs font-medium text-ink-subtle hover:text-alliance-dark transition-colors mb-4"
        >
          <ArrowLeft size={13} />
          Voltar ao catálogo
        </Link>
        <p className="text-xs font-semibold text-amber-600/80   mb-1">
          Catálogo
        </p>
