...
export function LeadDetailModal({ lead, open, onClose, onAssume, onTogglePause }: LeadDetailModalProps) {
  ...
  const tempoNoStage = formatDistanceToNow(new Date(lead.created_at), {
    locale: ptBR,
    addSuffix: false,
  })
                ...
                <Tooltip>
                  <TooltipTrigger
                    render={
                      <button
                        onClick={onClose}
                        className="text-white/60 hover:text-white transition-colors p-1 rounded-lg cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
              ...
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-4 py-3">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">
                    {lead.automation_paused
                      ? 'Respostas automaticas suspensas'
                ...
                <Tooltip>
                  <TooltipTrigger
                    render={
                      <button
                        ...
                        className={`flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 disabled:opacity-60 disabled:cursor-not-allowed ${
                          lead.automation_paused
                            ? 'bg-orange-100 text-orange-600 hover:bg-orange-200 focus-visible:ring-orange-400'
                            : 'bg-gray-200 text-gray-500 hover:bg-gray-300 focus-visible:ring-alliance-blue'
                        }`}
                      >
                        {pauseLoading ? (
                  ...
                  <TooltipContent side="top">
                    {lead.automation_paused ? 'Retomar respostas automaticas da IA' : 'Pausar respostas automaticas da IA'}
                  </TooltipContent>
                </Tooltip>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-alliance-dark/5 border border-alliance-dark/10 rounded-2xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-alliance-dark uppercase tracking-wider">Analise</span>
                </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-gray-50 rounded-xl px-4 py-3 text-center">
                  <p className="text-2xl font-bold text-alliance-dark">{interactionCount}</p>
                  <p className="text-xs text-gray-400 mt-0.5">interacoes</p>
                </div>
                <div className="bg-gray-50 rounded-xl px-4 py-3 text-center">
